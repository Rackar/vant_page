<template>
  <div class="content">
    ...
    <!-- <el-menu class="el-menu-demo" mode="horizontal" @select="handleSelect">
      ...
      <el-menu-item index="2">我要兑换</el-menu-item>
    ...
    >-->
    <!-- <div>
        孩子完成约定任务后加星，累积星星可兑换奖励。微信收藏本页方便记录。
    </div>-->
    ...
    <!-- </el-dialog> -->
    <!-- <el-dialog :visible.sync="settingDialogVisible" width="350px">
    ...
    <div>
      ...
      <!-- <el-button @click="dialogVisible = true">我要兑换</el-button> -->
      ...
      <van-rate v-model="todaystars" />
      <div style="margin-top:24px;">
        <van-button type="info" @click="adddata">提交</van-button>
      </div>
      <!-- </el-card> -->
    </div>
